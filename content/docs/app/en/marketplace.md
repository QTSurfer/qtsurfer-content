...
2. **Free listings** — click **Use strategy** to add it straight to your workspace.
3. **Premium listings** — require payment before the strategy is copied into your
   workspace and you can run backtests with it.
4. Once it's in your workspace, adapt parameters, instruments, and dates and run your own
...
2. Once it exists in your workspace, open **Share** on the revision you want to publish
