...
- Cuando el histórico de un par no lo gestiona la plataforma, súbelo como dataset: un CSV, un
  fichero parquet o un fichero lastra con una columna `timestamp` y otra `close`, opcionalmente con apertura, máximo,
