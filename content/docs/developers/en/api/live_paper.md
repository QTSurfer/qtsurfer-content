---
title: Paper trading on live runs
description: Execute a live run's signals in simulation — configure it, read its accounts, equity curve and KPIs.
order: 5.46
...
Each entry has the full signal shape described in [Live execution](live#signal-shape) (`v`,
