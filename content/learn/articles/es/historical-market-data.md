...
Para datos que QTSurfer no gestiona, puede subirse un **dataset** como CSV, parquet o lastra: una
fila de cabecera si es CSV (un fichero parquet o lastra ya lleva sus columnas con nombre), una columna `timestamp` en
